...
type AssetState struct {
	MaintenanceStop   *bool   `json:"maintenanceStop,omitempty"`   // is elevator in maintenance state
	MaintenanceReason *string `json:"maintenanceReason,omitempty"` // reason for maintenance state
